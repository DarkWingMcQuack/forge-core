...
auto UtilityTokenDeletionOp::getUtilityToken()
    -> UtilityToken&
{
    return token_;
}

auto UtilityTokenDeletionOp::getAmount() const
    -> std::uint64_t
{
    return amount_;
}
...
auto UtilityTokenDeletionOp::getCreator()
    -> std::string&
{
    return creator_;
}

auto UtilityTokenDeletionOp::getBlock() const
    -> std::int64_t
{
    return block_;
}
