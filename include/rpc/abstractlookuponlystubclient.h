...
#ifndef JSONRPC_CPP_STUB_BUDDY_RPC_ABSTRACTLOOKUPONLYSTUBCLIENT_H_
#define JSONRPC_CPP_STUB_BUDDY_RPC_ABSTRACTLOOKUPONLYSTUBCLIENT_H_

#include <jsonrpccpp/client.h>

namespace buddy {
    namespace rpc {
        class AbstractLookupOnlyStubClient : public jsonrpc::Client
        {
            public:
                AbstractLookupOnlyStubClient(jsonrpc::IClientConnector &conn, jsonrpc::clientVersion_t type = jsonrpc::JSONRPC_CLIENT_V2) : jsonrpc::Client(conn, type) {}
...
#endif //JSONRPC_CPP_STUB_BUDDY_RPC_ABSTRACTLOOKUPONLYSTUBCLIENT_H_
