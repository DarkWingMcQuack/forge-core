...
#ifndef JSONRPC_CPP_STUB_FORGE_RPC_JSONRPCSTUBCLIENT_H_
#define JSONRPC_CPP_STUB_FORGE_RPC_JSONRPCSTUBCLIENT_H_

#include <jsonrpccpp/client.h>

namespace forge {
    namespace rpc {
        class JsonRpcStubClient : public jsonrpc::Client
        {
            public:
                JsonRpcStubClient(jsonrpc::IClientConnector &conn, jsonrpc::clientVersion_t type = jsonrpc::JSONRPC_CLIENT_V2) : jsonrpc::Client(conn, type) {}
                ...
                Json::Value getownedutilitytokens() 
                {
                    Json::Value p;
                    p = Json::nullValue;
                    Json::Value result = this->CallMethod("getownedutilitytokens",p);
                    if (result.isArray())
                        return result;
                    else
                        throw jsonrpc::JsonRpcException(jsonrpc::Errors::ERROR_CLIENT_INVALID_RESPONSE, result.toStyledString());
                }
                Json::Value getwatchonlyutilitytokens() 
                {
                    Json::Value p;
                    p = Json::nullValue;
                    Json::Value result = this->CallMethod("getwatchonlyutilitytokens",p);
                    if (result.isArray())
                        return result;
                    else
                        throw jsonrpc::JsonRpcException(jsonrpc::Errors::ERROR_CLIENT_INVALID_RESPONSE, result.toStyledString());
                }
                Json::Value getallwatchedutilitytokens() 
                {
                    Json::Value p;
                    p = Json::nullValue;
                    Json::Value result = this->CallMethod("getallwatchedutilitytokens",p);
                    if (result.isArray())
                        return result;
                    else
                        throw jsonrpc::JsonRpcException(jsonrpc::Errors::ERROR_CLIENT_INVALID_RESPONSE, result.toStyledString());
                }
                std::string createnewutilitytoken(const std::string& address, int burnvalue, bool isstring, const std::string& key, const std::string& supply) 
                {
                    Json::Value p;
                    p["address"] = address;
                    p["burnvalue"] = burnvalue;
                    ...
                    p["key"] = key;
                    p["supply"] = supply;
                    Json::Value result = this->CallMethod("createnewutilitytoken",p);
                    if (result.isString())
                        return result.asString();
                    else
                        throw jsonrpc::JsonRpcException(jsonrpc::Errors::ERROR_CLIENT_INVALID_RESPONSE, result.toStyledString());
...
#endif //JSONRPC_CPP_STUB_FORGE_RPC_JSONRPCSTUBCLIENT_H_
