...
TEST(ReadOnlyOdinDaemonTest, processGetBlockHashValid)
{
    ...
    auto res_1 = forge::daemon::odin::processGetBlockHashResponse(std::move(json1), {});
...
TEST(ReadOnlyOdinDaemonTest, processGetBlockHashInvalid)
{
    ...
    auto res_2 = forge::daemon::odin::processGetBlockHashResponse(std::move(json2), {});
    ASSERT_TRUE(res_2.hasError());

    auto json_str3 = readFile("block_hash_invalid3.json");
    auto json3 = parseString(json_str3);

    auto res_3 = forge::daemon::odin::processGetBlockHashResponse(std::move(json3), {});
    ASSERT_TRUE(res_3.hasError());

    auto json_str4 = readFile("block_hash_invalid4.json");
    auto json4 = parseString(json_str4);

    auto res_4 = forge::daemon::odin::processGetBlockHashResponse(std::move(json4), {});
...
TEST(ReadOnlyOdinDaemonTest, processGetBlockCountValid)
{
    ...
    auto res_1 = forge::daemon::odin::processGetBlockCountResponse(std::move(json1), {});
    ASSERT_TRUE(res_1.hasValue());
}
...
TEST(ReadOnlyOdinDaemonTest, processGetBlockCountInvalid)
{
    ...
    auto res_2 = forge::daemon::odin::processGetBlockCountResponse(std::move(json2), {});
    ASSERT_TRUE(res_2.hasError());

    auto json_str3 = readFile("block_count_invalid3.json");
    auto json3 = parseString(json_str3);

    auto res_3 = forge::daemon::odin::processGetBlockCountResponse(std::move(json3), {});
    ASSERT_TRUE(res_3.hasError());

    auto json_str4 = readFile("block_count_invalid4.json");
    auto json4 = parseString(json_str4);

    auto res_4 = forge::daemon::odin::processGetBlockCountResponse(std::move(json4), {});
    ASSERT_TRUE(res_4.hasError());
}
...
TEST(ReadOnlyOdinDaemonTest, processGetUnspentValid)
{
    ...
    auto res_1 = forge::daemon::odin::processGetUnspentResponse(std::move(json1), {});
    ASSERT_TRUE(res_1.hasValue());
    ...
    auto res_2 = forge::daemon::odin::processGetUnspentResponse(std::move(json2), {});
    ...
    auto res_3 = forge::daemon::odin::processGetUnspentResponse(std::move(json3), {});
...
TEST(ReadOnlyOdinDaemonTest, processGetAddressesValid)
{
    ...
    auto res_1 = forge::daemon::odin::processGetAddressesResponse(std::move(json1));
...
TEST(ReadOnlyOdinDaemonTest, processGetAddressessInvalid)
{
    ...
    auto res_2 = forge::daemon::odin::processGetAddressesResponse(std::move(json2));
    ASSERT_TRUE(res_2.hasError());
    ...
    auto res_3 = forge::daemon::odin::processGetAddressesResponse(std::move(json3));
    ASSERT_TRUE(res_3.hasValue());
