...
TEST(ReadOnlyOdinDaemonTest, processGetAddressesValid)
{
    ...
    auto res_1 = buddy::daemon::odin::processGetAddressesResponse(std::move(json1));
...
TEST(ReadOnlyOdinDaemonTest, processGetAddressessInvalid)
{
    ...
    auto res_2 = buddy::daemon::odin::processGetAddressesResponse(std::move(json2));
    ASSERT_TRUE(res_2.hasError());
    ...
    auto res_3 = buddy::daemon::odin::processGetAddressesResponse(std::move(json3));
    ASSERT_TRUE(res_3.hasValue());
