...
{
    auto data1 = forge::core::stringToByteVec("ffffffff0100000000deadbeef").getValue();
    ...
    auto data2 = forge::core::stringToByteVec("ffffffff0100000000AA").getValue();
...
{
    auto data1 = forge::core::stringToByteVec("ffffffff04deadbeef").getValue();
    auto entry_opt1 = forge::core::parseKey(data1);
    std::vector expected1{
        (std::byte)0xde,
        (std::byte)0xad,
    ...
    auto data2 = forge::core::stringToByteVec("ffffffff04AA").getValue();
    auto entry_opt2 = forge::core::parseKey(data2);
    std::vector expected2{(std::byte)0xaa};
...
{
    auto data1 = forge::core::stringToByteVec("ffffffff0803000000deadbeef").getValue();
    auto entry_opt1 = forge::core::parseKey(data1);
    std::vector expected1{
        (std::byte)0xde,
        (std::byte)0xad,
    ...
    auto data2 = forge::core::stringToByteVec("ffffffff0810ffffffffffffffffffffffffffffffffAA").getValue();
    auto entry_opt2 = forge::core::parseKey(data2);
    std::vector expected2{(std::byte)0xaa};
    ...
    auto data3 = forge::core::stringToByteVec("ffffffff0800AA").getValue();
    ...
    auto data4 = forge::core::stringToByteVec("ffffffff0801CCAA").getValue();
...
{
    auto data1 = forge::core::stringToByteVec("ffffffff0201010101010101010101010101010101deadbeef").getValue();
    auto entry_opt1 = forge::core::parseKey(data1);
    std::vector expected1{
        (std::byte)0xde,
        (std::byte)0xad,
    ...
    auto data2 = forge::core::stringToByteVec("ffffffff0200000000000000000000000000000000AA").getValue();
    auto entry_opt2 = forge::core::parseKey(data2);
    std::vector expected2{(std::byte)0xaa};
...
{
    auto data1 = forge::core::stringToByteVec("ffffffff0100000000").getValue();
    auto entry_opt1 = forge::core::parseKey(data1);
...
{
    auto data1 = forge::core::stringToByteVec("ffffffff04").getValue();
    auto entry_opt1 = forge::core::parseKey(data1);
    EXPECT_FALSE(entry_opt1);
}
...
{
    auto data1 = forge::core::stringToByteVec("ffffffff080500000000").getValue();
    auto entry_opt1 = forge::core::parseKey(data1);
    EXPECT_FALSE(entry_opt1);
}
...
{
    auto data1 = forge::core::stringToByteVec("ffffffff0201010101010101010101010101010101").getValue();
    auto entry_opt1 = forge::core::parseKey(data1);
    EXPECT_FALSE(entry_opt1);
}
...
TEST(EntryTest, EntryValueParsingValidIpv4)
{
    ...
    auto data2 = forge::core::stringToByteVec("ffffffff01aabbccdddeadbeef").getValue();
...
{
    auto data1 = forge::core::stringToByteVec("ffffffff0200000000000000000000000000000000AA").getValue();
    auto entry_opt1 = forge::core::parseValue(data1);
    std::array expected1{
        (std::byte)0x00,
        (std::byte)0x00,
    ...
    auto data2 = forge::core::stringToByteVec("ffffffff02aabbccddeeff11223344556677889900deadbeef").getValue();
    auto entry_opt2 = forge::core::parseValue(data2);
    std::array expected2{
        (std::byte)0xaa,
        (std::byte)0xbb,
...
{
    auto data1 = forge::core::stringToByteVec("ffffffff01000000").getValue();
    auto entry_opt1 = forge::core::parseValue(data1);

    ASSERT_FALSE(entry_opt1);

    auto data2 = forge::core::stringToByteVec("ffffffff01aabbcc").getValue();
    auto entry_opt2 = forge::core::parseValue(data2);
...
{
    auto data1 = forge::core::stringToByteVec("ffffffff02000000000000000000000000000000").getValue();
    auto entry_opt1 = forge::core::parseValue(data1);

    ASSERT_FALSE(entry_opt1);

    auto data2 = forge::core::stringToByteVec("ffffffff02aabbccddeeff001122334455667788").getValue();
    auto entry_opt2 = forge::core::parseValue(data2);
...
TEST(EntryTest, EntryParsingValidIpv4)
{
    ...
    auto data2 = forge::core::stringToByteVec("ffffffff01aabbccddAA").getValue();
...
{
    auto data1 = forge::core::stringToByteVec("ffffffff0210101010101010101010101010101010deadbeef").getValue();
    auto entry_opt1 = forge::core::parseEntry(data1);
    std::vector key1{
        (std::byte)0xde,
        (std::byte)0xad,
